...
${prompt}`;
  ...
  if (!apiKey) {
    throw new Error(
      "Gemini AI Configuration Error: GEMINI_API_KEY environment variable is not set. Please add it to your .env file.",
    );
  }
  ...
  for (const modelName of MODELS_TO_TRY) {
    try {
      console.log(
        `🔌 Requesting dynamic Gemini analysis using model: ${modelName}...`,
      );
