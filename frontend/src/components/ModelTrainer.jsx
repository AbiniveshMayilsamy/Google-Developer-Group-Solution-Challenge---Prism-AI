...
import { BrainCircuit, Cpu, ShieldCheck, AlertTriangle, ArrowRight, Activity, Percent } from 'lucide-react';
  ...
  return (
    <div className="glass-panel" style={{ marginTop: '2.5rem', padding: '2rem' }}>
      <h3 style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1rem' }}>
        <BrainCircuit size={22} color="var(--accent-secondary)" /> Dedicated AI Model Training & Mitigation Simulator
      </h3>
